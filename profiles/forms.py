...
class ProfileForm(forms.ModelForm):
    ...
    birth_date = forms.DateTimeField(input_formats=settings.DATE_INPUT_FORMATS, widget=forms.DateInput(attrs={'class': 'datepicker', 'style': 'background-color: var(--wa-surface); color: var(--wa-text);'}))
    ...
    class Meta:
        model = Profile
        fields = ('bio', 'gender', 'hair_colour', 'hair_length', 'body_type', 'ethnicity', 
                 'relationship_status', 'looking_for', 'education', 'height', 'children', 'birth_date')
        widgets = {
