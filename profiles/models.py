...
if "DEVELOPMENT" in os.environ or "TESTING" in os.environ:
    ...
    def extend_sqlite(connection=None, **kwargs):
        if connection.vendor == 'sqlite':
            ...
            connection.create_function('acos', 1, math.acos)
            connection.create_function('cos', 1, math.cos)
            connection.create_function('radians', 1, math.radians)
            connection.create_function('sin', 1, math.sin)
...
class ProfileImage(models.Model):
    ...
    is_verified = models.CharField(max_length=20, default='PENDING')
