...
import time
from checkout.decorators import premium_required, return_subscription_status
...
@login_required
@premium_required
def your_premium_view(request):
    subscription_status = return_subscription_status(request)
    # Your view code here
    return render(request, 'your_template.html', {'subscription_status': subscription_status})